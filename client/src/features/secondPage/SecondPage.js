...
export default function SecondPage () {
  ...
  return (
    <ResponsiveContainer>
      ...
      <EmojiTextTableElement emoji={"💻"}>Ich beherrsche folgende Programmiersprachen: Go, Javascript, Typescritpt.</EmojiTextTableElement>
      <EmojiTextTableElement emoji={"👔"}>In meinen Berufsleben konnte ich bereits 1,5 Jahre nachweisbare Erfahrung in der Softwareentwicklung, insbesondere mit Java, Css3, Html5, Javascript sammeln.</EmojiTextTableElement>
