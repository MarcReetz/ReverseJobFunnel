...
export default function SecondPage () {
  ...
  return (
    <ResponsiveContainer>
      ...
      <EmojiTextTable>
      <EmojiTextTableElement emoji={"🙋🏻‍♂️"}>Die Basics: Ich bin Marc Reetz, 26 Jahre alt und wohne im schönen Bremen.</EmojiTextTableElement>
      <EmojiTextTableElement emoji={"💻"}>Ich beherrsche folgende Programmiersprachen: ABAP, Go, Javascript und Typescritpt.</EmojiTextTableElement>
      <EmojiTextTableElement emoji={"👔"}>In meinen Berufsleben konnte ich bereits 3,5 Jahre nachweisbare Erfahrung in der Softwareentwicklung, insbesondere mit ABAP, Java, Css3, Html5 und Javascript sammeln.</EmojiTextTableElement>
